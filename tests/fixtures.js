...
// #1045 and #1046 deliberately carry NO customer_id, so the suite covers both
// threads: an order linked to a customer record, and one matched only by the
// name it was written under -- which is what a walk-in, and every order taken
// before the column existed, still looks like.
export const orders = [
  { id: 1041, customer_name: "Reyes Events", customer_id: 201, items: [ { kind: "catalog", productId: 101, name: 'Styro Ball 4 inch', quantity: 40, unitPrice: 120, lineTotal: 4800, stockUnits: 40 }, { kind: "cut", name: 'Styro Sheet 1 inch, cut to 2ft x 1ft', quantity: 12, unitPrice: 90, lineTotal: 1080, stockUnits: 3, notes: "Cut to 2ft × 1ft for the stage backdrop" } ], total_amount: 6280, status: "Pending", created_at: iso(6), stock_committed_at: null },
  { id: 1042, customer_name: "Liza Villanueva", customer_id: 202, items: [ { kind: "catalog", productId: 104, name: 'Styro Sheet 1/2 inch', quantity: 4, unitPrice: 150, lineTotal: 600, stockUnits: 4 } ], total_amount: 600, status: "Pending", created_at: iso(1), stock_committed_at: null },
  { id: 1043, customer_name: "Bloom & Co", customer_id: 204, items: [ { kind: "catalog", productId: 102, name: 'Styro Ball 6 inch', quantity: 25, unitPrice: 185, lineTotal: 4625, stockUnits: 25 } ], total_amount: 4625, status: "Completed", created_at: iso(20), stock_committed_at: iso(16) },
  { id: 1044, customer_name: "Carlos Mendoza", customer_id: 203, items: [ { kind: "catalog", productId: 105, name: "Styro Block 2 inch", quantity: 2, unitPrice: 420, lineTotal: 840, stockUnits: 2, committedUnits: 0, voidedUnits: 2 } ], total_amount: 840, status: "Cancelled", created_at: iso(40), stock_committed_at: null, refunded_amount: 840, refund_history: [ { id: 5001, amount: 840, refundedAt: iso(38), refundedByStaffId: 1, refundedBy: "Maria Santos", reason: "changed-mind", method: "gcash", restockedItems: [ { productId: 105, name: "Styro Block 2 inch", quantity: 2, disposition: "restock" } ] } ], price_adjustments: [], backorder_status: "none" },
