...
export default function StaffDirectoryPage({
  ...
  return (
    <div className="mx-auto w-full max-w-[1160px]">
      <div className="mt-0 rounded-[14px] border border-[#17263a1a] bg-white px-6 py-5 shadow-[0_1px_2px_rgba(23,38,58,0.06)]">
        <div className="relative">
          <Search className="pointer-events-none absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-[#17263a80]" />
          <input
            type="text"
            value={query}
