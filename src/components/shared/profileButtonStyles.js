...
export const primaryButton =
  "flex h-[38px] items-center gap-2 rounded-lg bg-[#1746d1] px-[18px] text-[13.5px] font-semibold text-white shadow-[0_1px_3px_rgba(23,70,209,0.3)] transition hover:bg-[#1238ad]";
