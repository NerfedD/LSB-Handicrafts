        ...
        <div className="mt-3 rounded-2xl border border-[#17263a12] bg-white px-14 py-[52px] shadow-[0_8px_24px_rgba(17,30,50,0.12),0_2px_4px_rgba(17,30,50,0.07)]">
          ...
          <form onSubmit={handleSubmit} className="mt-8 flex flex-col">
            ...
            <input
              ...
              className="mt-2 h-14 w-full rounded-[10px] border border-[#17263a29] bg-white px-[18px] text-[17px] text-[#17263a] outline-none transition focus:ring-2 focus:ring-[#1b3a6b]/30"
            />

            <label
              htmlFor="contact"
              className="mt-[22px] block text-[13.5px] font-semibold text-[#17263a]"
            >
