...
export default function Dashboard({ inventory, deliveries, orders = [], activityLog = [] }) {
  ...
  //ALLU: Control the audit-history modal state from Dashboard to avoid extra global state.
  ...
  //ALLU: Build a compact "recent activity" feed from orders and deliveries for dashboard visibility.
  ...
  return (
    <div className="animate-in fade-in duration-300">
        ...
        <div className="bg-white dark:bg-[#111116] border border-zinc-200 dark:border-[#1F1F2E] rounded-2xl p-5 md:p-6 shadow-sm dark:shadow-none w-full">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-2">
              {/* //ALLU: Surface full activity history on-demand through a modal to keep dashboard concise. */}
              <button 
      ...
      {/* //ALLU: Show persisted timeline entries in a focused modal for quick audit review. */}
      {showHistory && (
