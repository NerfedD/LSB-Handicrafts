  ...
  return (
    <div className="mx-auto w-[520px] max-w-full">
      ...
      <div className="mt-3 rounded-2xl border border-[#17263a12] bg-white px-14 py-13 shadow-[0_8px_24px_rgba(17,30,50,0.12),0_2px_4px_rgba(17,30,50,0.07)]">
        ...
        <div className="mt-8 flex items-center gap-4 rounded-xl border border-[#17263a12] bg-[#f7f4ec] px-6 py-5">
        ...
        <div className="mt-5 grid grid-cols-2 gap-6">
          <div>
            ...
            <div className="mt-3 flex h-13 items-center rounded-[10px] border border-[#17263a1a] bg-[#17263a0a] px-4 text-base font-semibold text-[#17263a80]">
              {account.role}
            </div>
          </div>
          <div>
            ...
            <select
              ...
              className={`mt-3 h-13 w-full rounded-[10px] border border-[#17263a29] bg-white px-4 text-[15.5px] outline-none focus:ring-2 focus:ring-[#1b3a6b]/30 ${
