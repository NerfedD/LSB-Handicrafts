    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex justify-between items-end mb-4 md:mb-8">
        <div>
          ...
          <p className="text-xs md:text-sm text-slate-500 dark:text-gray-500 mt-1">A quick summary of inventory activity and system status.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
        <div className="bg-white dark:bg-gradient-to-br dark:from-[#15151a] dark:to-[#101014] border border-slate-200 dark:border-white/5 rounded-2xl p-4 md:p-6 relative group hover:border-slate-300 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
          ...
          <p className="text-2xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 md:mb-4">{totalProducts}</p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-[#15151a] dark:to-[#101014] border border-slate-200 dark:border-white/5 rounded-2xl p-4 md:p-6 relative group hover:border-slate-300 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
          ...
          <p className="text-2xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 md:mb-4">{totalStock}</p>
          <p className="text-[10px] md:text-xs font-bold text-slate-400 dark:text-gray-500 flex items-center gap-1">
        ...
        <div className="bg-gradient-to-br from-red-50 to-orange-50/50 dark:from-[#151010] dark:to-[#100a0a] border border-red-100 dark:border-red-500/10 rounded-2xl p-4 md:p-6 relative group transition-colors shadow-sm dark:shadow-none">
          ...
          <p className="text-2xl md:text-4xl font-black text-red-600 dark:text-red-400 mb-2 md:mb-4">{lowStockCount}</p>
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-[#15151a] dark:to-[#101014] border border-slate-200 dark:border-white/5 rounded-2xl p-4 md:p-6 relative group hover:border-slate-300 dark:hover:border-white/10 transition-colors shadow-sm dark:shadow-none">
          <button className="hidden md:block absolute top-6 right-6 text-slate-400 dark:text-gray-500 hover:text-slate-900 dark:hover:text-white"><Icons.Dots /></button>
          <h3 className="text-xs md:text-sm font-bold text-slate-500 dark:text-gray-400 mb-2 md:mb-4">Categories</h3>
          <p className="text-2xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 md:mb-4">{categoryCount}</p>
          <p className="text-[10px] md:text-xs font-bold text-slate-400 dark:text-gray-500 flex items-center gap-1">
            <span>Grouped inventory types</span>
          </p>
        </div>
      </div>
